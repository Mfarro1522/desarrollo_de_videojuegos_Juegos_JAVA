...
public class Ghoul extends NPC {
    ...
    private synchronized void cargarSpritesEstaticos() {
        ...
        try {
            ...
            s_der1 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ghoulDer01.png")), tile, tile);
            s_der2 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ghoulDer02.png")), tile, tile);
            s_der3 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ghoulDer03.png")), tile, tile);
            s_der4 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ghoulDer04.png")), tile, tile);
            ...
            s_ataqueDer1 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ataqueDer1.png")), tile, tile);
            s_ataqueDer2 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ataqueDer2.png")), tile, tile);
            s_ataqueDer3 = tool.escalarImagen(ImageIO.read(Ghoul.class.getResourceAsStream(ruta + "ataqueDer3.png")), tile, tile);
    ...
    protected BufferedImage obtenerSprite() {
        if (estaAtacando) {
            ...
            if (usarIzquierda) {
                switch (frameActual) {
                    case 1: return ataqueIzq1; case 2: return ataqueIzq2;
                    case 3: return ataqueIzq3; default: return ataqueIzq1;
                }
            } else {
                switch (frameActual) {
                    case 1: return ataqueDer1; case 2: return ataqueDer2;
                    case 3: return ataqueDer3; default: return ataqueDer1;
                }
            }
        }
