...
public class Slime extends NPC {
    ...
    private synchronized void cargarSpritesEstaticos() {
        ...
        try {
            ...
            s_arriba1 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Arriba01.png")), tile, tile);
            s_arriba2 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Arriba02.png")), tile, tile);
            s_abajo1 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Abajo01.png")), tile, tile);
            s_abajo2 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Abajo02.png")), tile, tile);

            s_derecha1 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Derecha01.png")), tile, tile);
            s_derecha2 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Derecha02.png")), tile, tile);
            s_izquierda1 = tool.voltearImagenHorizontal(s_derecha1);
            s_izquierda2 = tool.voltearImagenHorizontal(s_derecha2);

            s_muerte1 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Muerte01.png")), tile, tile);
            s_muerte2 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Muerte02.png")), tile, tile);
            s_muerte3 = tool.escalarImagen(ImageIO.read(Slime.class.getResourceAsStream(ruta + "Muerte03.png")), tile, tile);
    ...
    @Override
    public void actualizarIA() { perseguirJugador(); }
